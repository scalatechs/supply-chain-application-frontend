    ...
    return (
        <div className="flex flex-col items-start gap-6 w-full">
            <div className="w-full flex items-center justify-between">
                <h1 className="text-3xl font-medium">Restock Product</h1>
            ...
            <div className='w-full flex items-start justify-between gap-6'>
                <div className='w-1/2 flex flex-col items-start gap-6'>
                    <div className='border rounded-lg flex items-start gap-6 p-4 w-full'>
                        <div className='border rounded-lg w-1/5 p-2'>
                            <img src={product.image} alt="" />
                        </div>
                        <div className='flex flex-col gap-2 w-full'>
                            <h1 className='text-3xl capitalize mb-4'>{product.name}</h1>
                    ...
                    <div className='border rounded-lg flex flex-col items-start p-4 w-full'>
                        <h1 className='text-2xl capitalize mb-4 font-medium'>Product Description</h1>
                        <Separator />
                        <p className='text-base mt-4 text-neutral-700'>
                ...
                <div className='w-1/2 flex flex-col items-start gap-6'>
                    <div className='border rounded-lg flex flex-col items-start w-full'>
                        <h1 className='text-2xl capitalize mb-4 font-medium px-4 mt-4'>Product Sales Statistics</h1>
                        <ProductSales units={product.stock} />
                    </div>
                    <div className='border rounded-lg flex flex-col items-start w-full p-4'>
                        <h1 className='text-2xl capitalize mb-4 font-medium'>Restock Variants</h1>
                        <Separator />
                        <RestockVariants />
                    </div>
                </div>
